...
# --- 1. ตั้งค่า Path แบบอัตโนมัติ (เพื่อนโหลดไป รันได้เลย) ---
...
# โฟลเดอร์สำหรับเก็บผลลัพธ์ (ถ้าต้องการบันทึก)
...
def main():
    ...
    cv2.resizeWindow("Tilapia Detection", 800, 600) # ปรับขนาดหน้าต่างตามชอบ

    print("🟢 กำลังทำงาน... กด 'q' เพื่อออก")
